...
function __construct() {
    ...
    public function index() {
        ...
        $show_promo = $this->Frontend_model->getpromotions();
        $vendor_review = $this->Frontend_model->get_vendorReviews();
        $show_recommend = $this->Frontend_model->getreommendation();
        $wedding_theme = $this->Frontend_model->getAllValues('wedding_theme', 'id');
        $data = array(
   ...
   public function user_checklist(){
      ...
      $this->site_data['get_cheked_to_do'] =  $this->Frontend_model->get_checklist_done('1');
